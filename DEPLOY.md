...
Я не знаю, возможно ли будет реализовать запуск выполнение блока кода по условию наличия изменений, 
поэтому ниже схематично поствил заглушку для условия 
```bash
...
Возможно, это поможет понять мою идею
```bash
