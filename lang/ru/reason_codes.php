...
return [
    ...
    'attempt_can_be_banned_only_on_attempt_day' => 'Аннулировать попытку возможно только в день ее прохождения',
    'attempt_has_been_already_started' => 'Говорение уже начато',
    'attempt_speaking_is_not_started_yet' => 'Говорение не начато',
